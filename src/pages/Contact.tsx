            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                >
                  <div className="flex items-start">
                    <div className="w-12 h-12 bg-altivum-gold/20 rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                      <span className="material-icons text-altivum-gold text-3xl">phone</span>
                    </div>
                    <div>
                ...
                >
                  <div className="flex items-start">
                    <div className="w-12 h-12 bg-altivum-gold/20 rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                      <span className="material-icons text-altivum-gold text-3xl">email</span>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">
                        General Inquiries
                ...
                >
                  <div className="flex items-start">
                    <div className="w-12 h-12 bg-altivum-gold/20 rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                      <span className="material-icons text-altivum-gold text-3xl">business_center</span>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">
                ...
                >
                  <div className="flex items-start">
                    <div className="w-12 h-12 bg-altivum-gold/20 rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                      <span className="material-icons text-altivum-gold text-3xl">person</span>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">
                        Direct Email
